...
png("outputs/venn.png", width = 1000, height = 700)
...
I have put this whole chunk in the function 
```{r, eval=FALSE}
...
```{r}
kmeansHeatmap(k_tb, clusters= 8:15, nstart = 100, GSEA = TRUE,
              scaled = "unscaled")
```
