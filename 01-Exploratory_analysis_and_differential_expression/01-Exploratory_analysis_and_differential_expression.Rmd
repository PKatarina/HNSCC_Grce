...
mRNA_res <- results(mRNA_dds, contrast = c("Hist","cancer","control"))
...
publish_gostplot(gostplot(gost_mRNA ,capped = F, interactive = F),
                 highlight_terms = read.csv("inputs/GSEA_terms/gost_mRNA_terms.txt", 
                                            header = F)[,1],
                 filename = "outputs/figures/gost_plot_mRNA_highlighted.png")
```
...
```{r mir sample distance heatmap-triangle}
